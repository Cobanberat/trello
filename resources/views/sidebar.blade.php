...
@section('sidebar')
    <div class="sidebar">
        ...
        <div class="sidebar-down">
            ...
            <div class="tabledate">
                <div class="workingareasx" id="sidebar-texts">
                    <div class="div-bslk">
                        <div class="pano">
    ...
    <div class="sidebar-open-button d-none">
        <div class="button-svg">
            <i class="bi bi-chevron-right" style="color: #fff; font-size: 8px; text-shadow: 1px 0 0 #fff, -1px 0 0 #fff, 0 1px 0 #fff, 0 -1px 0 #fff;"></i>
            </div>
        </div>
@endsection
