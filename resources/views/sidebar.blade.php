...
@section('sidebar')
    ...
    <div class="sidebar">
        <div class="sidebar-main">
            ...
            <div class="sidebar-main-button">
                <i class="bi bi-chevron-left dv-color"
        ...
        <div class="sidebar-down">
            <div class="sidebar-options">
                <a href="/dashboard" class="panolar" id="sidebar-texts">
                    <div class="div-bslk">
                        <svg class="dv-color" width="17" height="17" role="presentation" focusable="false"
                ...
                <div class="workingarea" id="sidebar-texts">
                    <div class="div-bslk">
                        <svg style="" class="dv-color" width="17" height="17" role="presentation" focusable="false"
                            viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
    ...
    <div class="sidebar-open-button d-none">
        <div class="button-svg dv-color">
            <i class="bi bi-chevron-right "
                style=" font-size: 8px; text-shadow: 1px 0 0 #fff, -1px 0 0 #fff, 0 1px 0 #fff, 0 -1px 0 #fff;"></i>
        </div>
    </div>
@endsection
