<!DOCTYPE html>
@php
        $theme = App\Models\Theme::where('user_id', Auth::id())->first();
    $themeType = isset($theme) ? ($theme->type == 1 ? 'dark' : 'light') : 'light';
@endphp
<html lang="en" data-bs-theme="{{ $themeType }}">
            ...
            <div class="left text-center">
                <div class="dropdown">
                    <div class="left-button-hover cursor-pointer" id="dropdownMenuButton" data-bs-toggle="dropdown"
                        aria-expanded="false">
                        <svg width="20" class="dv-color" height="20" role="presentation" focusable="false"
                    ...
                    <ul class="dropdown-menu dropdown-gecmis">
                        @if ($lastBoard)
                            <a href="/boards/{{ $lastBoard->id }}" class="gecmis-container">
                                <div class="img-background"></div>
                                <div class="gecmis-text">
                                    <span class="text-gecmis-span">{{ $lastBoard->name }}</span>
                                    <span class="text-gecmis-workarea">Trello Çalışma Alanı</span>
                                </div>
                                <div class="gecmis-fav-logo">
                                    <div class="workingas">
                                        ...
                                        <span>
                                            <svg width="24" height="24" role="presentation" focusable="false"
                                                ...
                                                <path
                                                    ...
                                                    fill="currentColor"></path>
                                                <path
                                                    d="M2 12C2 11.4 477 2.44772 11 3 11C3.55228 11 4 11.4477 4 12V13C4 13.5523 3.55228 14 3 14C2.44772 14 2 13.5523 2 13V12Z"
                                                    fill="currentColor"></path>
                                                <path
                                ...
                                <div class="dropdown-sidebar-trello">
                                    <div class="trello-sidebar-container">
                                        ...
                                        <div class="trello-nav">
                                            ...
                                            <div class="trello-nav-item dropend">
                                                <span data-bs-toggle="dropdown" aria-expanded="false"
                                                    data-bs-auto-close="outside"> Tema <i
                                                        class="bi bi-chevron-right"></i></span>

                                                <ul id="theme-inputs" class="dropdown-menu">
                                                    <label class="themeClass d-flex align-items-center p-2 gap-3">
                                                        <div class="theme-check">
                                                            <input type="radio" name="theme" value="light"
                                                                {{ isset($theme) && $theme->type == 0 ? 'checked' : '' }}>
                                                        </div>
                                                        <div class="theme-img">
                                                            <img src="https://trello.com/assets/a3a279edd7e5baaef4f7.svg"
                                                                alt="">
                                                        </div>
                                                    ...
                                                    <label class="themeClass d-flex align-items-center p-2 gap-3">
                                                        <div class="theme-check">
                                                            <input type="radio" name="theme" value="dark"
                                                                {{ isset($theme) && $theme->type == 1 ? 'checked' : '' }}>
                                                        </div>
                                                        <div class="theme-img">
                                                            <img src="https://trello.com/assets/cb4097b01b57e5d91727.svg"
                                                                alt="">
                                                        </div>
                                                        <div class="theme-text">
                                                            <span>Koyu</span>
