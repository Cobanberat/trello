                            ...
                            <div class="card-body">
                                ...
                                <div class="card-text-body sortable">
                                    ...
                                    @foreach ($card as $row)
                                            ...
                                            @if ($row->backgroundsImgType)
                                                <div class="cardImg" data-card-id="{{ $row->id }}">
                                                    <img style="width:100%;height:200px"
                                                        src="{{ asset('storage/' . $row->backgroundsImgType->img) }}"
                                                        alt="">
                                                </div>
                                            @endif
                                            <div data-id="{{ $row->id }}"
                                                                                        ...
                                                                                        <div class="d-flex flex-column">
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <div class="d-flex gap-2">
                                                                                                    ...
                                                                                                    <div class="d-flex flex-column justify-content-end img-show-two gap-2"
                                                                                                        @if ($row->backgrounds) style="background-color:{{ $row->backgrounds->renk }}" @endif>
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    @if ($row->backgroundsImg)
                                                                                                        <div class="img-eklenti d-flex gap-2 flex-wrap"
                                                                                                            style="padding-left:15px;padding-top:10px;padding-bottom:10px; padding-right:15px">
                                                                                                            @foreach ($row->backgroundsImg as $img)
                                                                                                                <div
                                                                                                                    class="img-eklenti-item">
                                                                                                                    <img src="{{ asset('storage/' . $img->img) }}"
                                                                                                                        data-id='{{ $img->id }}'
                                                                                                                        data-card-id='{{ $img->card_id }}'
                                                                                                                        alt=""
                                                                                                                        class="imgEklenti{{ $img->durum == 1 ? 'borderImg' : '' }}"
                                                                                                                        style="width:84px;height:48px; border-radius:5px">
                                                                                                                </div>
                                                                                                            @endforeach
                                        ...
                                        <div class="modal fade modalMenu1" id="exampleModal{{ $row->id }}"
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="modal-card-name mt-3">
                                                            <div class="d-flex align-items-center gap-2">
                                                                <span
                                                                    class="card-name-modal fs-5 fw-bold">{{ $row->name }}</span>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div style="padding-left:10px;padding-right:10px;"
                                                                ...
                                                                @if ($row->explanation)
                                                                    <div class="explanation-content"
                                                                        style="width: 100%; min-height: 60px; background-color: #e4e6ea; padding: 10px; cursor: pointer;">
                                                                        {{ $row->explanation }}
                                                                    </div>
                                                                @else
