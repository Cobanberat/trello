                        ...
                        <div class="card" style="width: 17rem">
                            <div class="card-body">
                                ...
                                <div class="card-text-body sortable">
                                    @php $card = App\Models\card::where('list_id',$list->id)->get(); @endphp
                                    @foreach ($card as $row)
                                        <ul class="card-texts" data-card-id="{{ $row->id }}">
                                            <span>{{ $row->name }}</span>
                                            <div class="düzenle_svg">
                                                ...
                                                <div class="card" oncontextmenu="showMenu(event)">
                                                  ...
                                                  <div id="contextMenu" class="context-menu">
                                                    <ul>
                                                      <li onclick="openCard()">Kartı Aç</li>
                                                      <li onclick="editLabels()">Etiketleri Düzenle</li>
                                                      <li onclick="moveCard()">Taşı</li>
                                                      <li onclick="copyCard()">Kartı Kopyala</li>
                                                      <li onclick="archiveCard()">Arşivle</li>
                                                    </ul>
                                                  </div>
                                            </div>
