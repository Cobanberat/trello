...
<head>
    ...
    <title>Devam etmek için oturum açın</title>
            ...
            <form class="loginFormClass" action="registerKayit" method="post">
                <div class="login-bslk d-flex flex-column gap-3">
                    <svg viewBox="0 0 94 32" height="35" fill="none" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <defs>
                            <linearGradient id="uid5" x1="9.33821" y1="23.6824" x2="9.33821" y2="5.00599"
                                gradientUnits="userSpaceOnUse">
                                <stop stop-color="#0052CC" offset="0%"></stop>
                                <stop stop-color="#2684FF" offset="100%"></stop>
                            </linearGradient>
                        </defs>
                        <path fill="var(--ds-text, #172B4D)" fill-rule="evenodd" clip-rule="evenodd"
                ...
                <div class="login-input d-flex flex-column gap-3">
                    ...
                    <div class="d-flex flex-column gap-2">
                        <div class="d-flex flex-column">
                            <label class="form-input-label" for="">Tam ad</label>
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <label style="font-weight: 400; font-size: 11px; color: #535963;" for="hatirla">Evet!
                                Ürünler, etkinlikler ve daha fazlası hakkında Atlassian'dan haberler ve teklifler
                                gönderilsin.</label>
                        </div>
                        <div class="d-flex form-text-a">
                            <span>Kaydolarak Atlassian <a href="">Cloud Hizmet Koşullarını </a>
                                kabul ediyorum ve <a href=""> Gizlilik Politikasını</a> onaylıyorum.</span>
                        </div>
                    </div>
                    ...
                    <div class="d-flex align-items-center justify-content-center">
                        <svg viewBox="0 0 190 32" height="32" xmlns="http://www.w3.org/2000/svg" focusable="false"
                            ...
                            <g stroke="none" stroke-width="1" fill="#505F79">
                                ...
                                <rect fill="inherit" x="142.740005" y="9.07000017" width="4.45677247"
