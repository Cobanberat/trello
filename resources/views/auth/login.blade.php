...
<body>
    ...
    <div class="login-bg">
        <div class="login-container">
            <br>
            <form class="loginFormClass" action="/logincontrol" method="post">
                @csrf      
                <div class="login-bslk d-flex flex-column gap-3">
                    ...
                    <span> Devam etmek için oturum açın</span>
                </div>
                <div class="login-input d-flex flex-column gap-3">
                    <div class="d-flex flex-column gap-2">
                        ...
                        <div class="mail-input-div">
                            <input class="mail-input" type="password" name="password" placeholder="Şifre Girin">
                        </div>
                    </div>
                    <div class="d-flex align-items-center gap-2">
                        <input type="checkbox" name="hatirla" id="hatirla">
                        <label style="font-weight: 400; font-size: 14px;" for="hatirla">Beni hatırla</label>
                    </div>
